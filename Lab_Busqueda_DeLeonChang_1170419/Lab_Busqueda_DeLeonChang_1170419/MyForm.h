...
private: System::Void BtnBusquedaSecuencial_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Int16 BusquedaBinaria(ArrayList^ Arreglo, int valorBuscar, int size) {
		...
		Timer->Stop();
		System::Windows::Forms::MessageBox::Show("RECORDATORIO para utilizar busqueda binaria tiene que estar ordenado el vector, Tiempo de ejecución: " + System::Convert::ToString(Timer->Elapsed));
		return -1;
		//return middle + 1;
	}
}
